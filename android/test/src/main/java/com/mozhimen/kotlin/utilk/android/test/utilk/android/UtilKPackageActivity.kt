...
class UtilKPackageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: android.os.Bundle?) {
        ...
        UtilKLogWrapper.d(TAG, "onCreate: ${UtilKApplicationInfo.get_ofPackageInfo(this.packageName, 0, this)}")
        UtilKLogWrapper.d(TAG, "onCreate: ${UtilKApplicationInfo.get_ofPackageManager(this.packageName, 0, this)}")
    }
}