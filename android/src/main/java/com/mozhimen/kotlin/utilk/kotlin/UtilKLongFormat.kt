...
fun Long.longFileSize2strFileSize_global(suffix: String = "B", bit: Int = 2): String =
    UtilKLongFormat.longFileSize2strFileSize_global(this, suffix, bit)
...
object UtilKLongFormat : IUtilK {
    ...
    @JvmStatic
    fun longFileSize2strFileSize_global(fileSize: Long, suffix: String = "B", bit: Int = 2): String =
        longFileSize2strFileSize(fileSize, suffix, bit, Locale.ENGLISH)
